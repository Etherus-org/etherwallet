    ...
    <section class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div ng-show="browserProtocol=='https:'" class="alert alert-danger small" translate="NODE_Warning">
          Your node must be HTTPS in order to connect to it via Wallet.Etherus.org. You can [download the Wallet.Etherus.org repo & run it locally](https://github.com/dukei/etherwallet/releases/latest) to connect to your local node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)</a>.
        </div>
        ...
        <section class="row">
          ...
          <div class="clearfix col-xs-12 radio">
            <label><input name="options" type="radio" ng-model="customNode.options" value="etr"> ETR </label>
