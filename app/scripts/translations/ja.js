...
ONBOARD_secure_1_content__3     :  'いつも、必ず、URLが「https://www.myetherwallet.com」であるを確認してください。', /*Always check the URL: `https://wallet.etherus.org`.*/
...
TXFEE_Desc                  : 'トランザクション手数料は、トランザクションをブロックへ組み込むためにマイナーに支払われます。`ガスリミット` × `ガス価格`で算出されます。 [GWEI -> ETHの単位変換はこちらからどうぞ](https://wallet.etherus.org/helpers.html)',　/*The TX Fee is paid to miners for including your TX in a block. It is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://wallet.etherus.org/helpers.html)*/
...
HELP_Sec_Desc_4             : 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://wallet.etherus.org](https://wallet.etherus.org).',
